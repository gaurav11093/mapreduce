...
public class MapReduceExampleMain extends Configured implements org.apache.hadoop.util.Tool {
  ...
  public int run(String[] args) throws Exception {
    String comaSeparatedInputFilePathsString = "gg/mapreduce/input/TitanicData.txt,gg/mapreduce/input/TitanicData1.txt";
...
//    job.setReducerClass(IntSumReducer.class);
    ...
    job.getConfiguration().set("mapreduce.output.fileoutputformat.outputdir","gg/mapreduce/output");
